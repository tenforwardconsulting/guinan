		...
		try {
			...
			while (eventType != XmlPullParser.END_DOCUMENT)
			{
				if ( eventType == XmlPullParser.START_TAG) {
				  if ( xrp.getName() == "feature" && 
						xrp.getAttributeValue(null, "name") == "CloudFivePush" ) {
					  insideFeature = true;
				  }else if (insideFeature && xrp.getName() == "param" && xrp.getAttributeValue(null, "name") == "gcmSenderId") {
